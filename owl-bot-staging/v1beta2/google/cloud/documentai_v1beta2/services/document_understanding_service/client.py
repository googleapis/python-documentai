...
class DocumentUnderstandingServiceClient(metaclass=DocumentUnderstandingServiceClientMeta):
    ...
    def transport(self) -> DocumentUnderstandingServiceTransport:
        ...
        Returns:
            DocumentUnderstandingServiceTransport: The transport used by the client
                instance.
        """
    ...
    def batch_process_documents(self,
            request: Optional[Union[document_understanding.BatchProcessDocumentsRequest, dict]] = None,
            *,
            requests: Optional[MutableSequence[document_understanding.ProcessDocumentRequest]] = None,
    ...
    def process_document(self,
            request: Optional[Union[document_understanding.ProcessDocumentRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Optional[float] = None,
            metadata: Sequence[Tuple[str, str]] = (),
