...
class EvaluationReference(proto.Message):
    ...
    Attributes:
        ...
        aggregate_metrics (google.cloud.documentai_v1.types.Evaluation.Metrics):
            An aggregate of the statistics for the
            evaluation with fuzzy matching on.
        aggregate_metrics_exact (google.cloud.documentai_v1.types.Evaluation.Metrics):
            An aggregate of the statistics for the
...
class Evaluation(proto.Message):
    ...
    Attributes:
        ...
        document_counters (google.cloud.documentai_v1.types.Evaluation.Counters):
            Counters for the documents used in the
            evaluation.
        all_entities_metrics (google.cloud.documentai_v1.types.Evaluation.MultiConfidenceMetrics):
            Metrics for all the entities in aggregate.
        entity_metrics (MutableMapping[str, google.cloud.documentai_v1.types.Evaluation.MultiConfidenceMetrics]):
    ...
    class ConfidenceLevelMetrics(proto.Message):
        ...
        Attributes:
            ...
            metrics (google.cloud.documentai_v1.types.Evaluation.Metrics):
