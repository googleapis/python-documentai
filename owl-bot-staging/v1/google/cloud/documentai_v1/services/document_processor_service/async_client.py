...
from google.cloud.documentai_v1.types import document_schema
...
class DocumentProcessorServiceAsyncClient:
    ...
    parse_evaluation_path = staticmethod(DocumentProcessorServiceClient.parse_evaluation_path)
    ...
    processor_type_path = staticmethod(DocumentProcessorServiceClient.processor_type_path)
    parse_processor_type_path = staticmethod(DocumentProcessorServiceClient.parse_processor_type_path)
    processor_version_path = staticmethod(DocumentProcessorServiceClient.processor_version_path)
    parse_processor_version_path = staticmethod(DocumentProcessorServiceClient.parse_processor_version_path)
    ...
    async def process_document(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.ProcessRequest, dict]]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def batch_process_documents(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.BatchProcessRequest, dict]]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def fetch_processor_types(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.FetchProcessorTypesRequest, dict]]):
    ...
    async def list_processor_types(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.ListProcessorTypesRequest, dict]]):
    ...
    async def get_processor_type(self,
    ...
    async def list_processors(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.ListProcessorsRequest, dict]]):
    ...
    async def get_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.GetProcessorRequest, dict]]):
                The request object. Request message for get processor.
            name (:class:`str`):
    ...
    async def train_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.TrainProcessorVersionRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            processor_version (:class:`google.cloud.documentai_v1.types.ProcessorVersion`):
    ...
    async def get_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.GetProcessorVersionRequest, dict]]):
                The request object. Request message for get processor
                version.
            name (:class:`str`):
                Required. The processor resource
    ...
    async def list_processor_versions(self,
    ...
    async def delete_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.DeleteProcessorVersionRequest, dict]]):
    ...
    async def deploy_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.DeployProcessorVersionRequest, dict]]):
    ...
    async def undeploy_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.UndeployProcessorVersionRequest, dict]]):
    ...
    async def delete_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.DeleteProcessorRequest, dict]]):
                The request object. Request message for the delete
                processor method.
            name (:class:`str`):
    ...
    async def enable_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.EnableProcessorRequest, dict]]):
    ...
    async def disable_processor(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.DisableProcessorRequest, dict]]):
    ...
    async def set_default_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.SetDefaultProcessorVersionRequest, dict]]):
    ...
    async def review_document(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.ReviewDocumentRequest, dict]]):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def evaluate_processor_version(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.EvaluateProcessorVersionRequest, dict]]):
    ...
    async def get_evaluation(self,
        ...
        Args:
            request (Optional[Union[google.cloud.documentai_v1.types.GetEvaluationRequest, dict]]):
