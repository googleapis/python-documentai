...
class DocumentProcessorServiceClient(metaclass=DocumentProcessorServiceClientMeta):
    ...
    @staticmethod
    def evaluation_path(project: str,location: str,processor: str,processor_version: str,evaluation: str,) -> str:
        """Returns a fully-qualified evaluation string."""
        return "projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}/evaluations/{evaluation}".format(project=project, location=location, processor=processor, processor_version=processor_version, evaluation=evaluation, )

    @staticmethod
    def parse_evaluation_path(path: str) -> Dict[str,str]:
        """Parses a evaluation path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/processors/(?P<processor>.+?)/processorVersions/(?P<processor_version>.+?)/evaluations/(?P<evaluation>.+?)$", path)
    ...
    def train_processor_version(self,
    ...
    def evaluate_processor_version(self,
