...
- While logged into your GitHub account, navigate to the
  ``python-documentai`` `repo`_ on GitHub.

- Fork and clone the ``python-documentai`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-documentai`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-documentai``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-documentai.git hack-on-python-documentai
   $ cd hack-on-python-documentai
   # Configure remotes such that you can pull changes from the googleapis/python-documentai
   # repository into your local repository.
   $ git remote add upstream git@github.com:googleapis/python-documentai.git
...
.. _repo: https://github.com/googleapis/python-documentai
